import { isFunction, isGenerator } from "../utilities";
 ...
 */
const performSync = function performSync(task) {

	if (!isGenerator(task)) {
		throw TypeError(`${task} is not a generator function`)
	}

	// create an object that is prototype linked with the 'performSync.prototype' object
	const _this = Object.create(performSync.prototype);
...
// the objects generated by 'performSync' will have only one method: the 'catch' method
// this avoid weird 'finally' or 'try' calls without a proper 'catch' call

// do you know about hoisting? :P
performSync.prototype.catch = _catch;
...
/**
 *
 * @param this Always an object created by performSync->catch || performSync->catch->finally chains
 * *
 */
function run() {
